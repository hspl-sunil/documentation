...
To view the employee contracts, head to the :guilabel:`Payroll` application, then go to
...
- :guilabel:`Start Date`: The date the contract starts. Choose a date by clicking on the drop-down
  menu, navigating to the correct month and year by using the arrow icons, then clicking on the
  date.
...
- :guilabel:`Document`: The attached document can be replaced by clicking the
  :guilabel:`🖉 (Select)` icon. A pop-up window appears so another document can be selected for
